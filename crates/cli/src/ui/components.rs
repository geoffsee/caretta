...
.editor-layout { display: flex; height: 100%; min-height: 0; }
.file-list {
    width: 250px;
    border-right: 1px solid var(--border);
    display: flex;
...
.file-list-tab:last-child { border-right: none; }
.file-list-tab:hover { color: var(--fg-primary); }
...
.file-search input:focus { border-color: var(--blue); }
.file-entry {
    padding: 4px 8px;
    cursor: pointer;
    white-space: nowrap;
...
.file-entry:hover { background: var(--bg-secondary); }
.file-entry-active { background: var(--bg-secondary); border-left: 2px solid var(--blue); }
.file-kind {
    width: 14px;
    text-align: center;
    font-weight: 700;
...
.persona-seed-input:focus { border-color: var(--blue); }
.persona-seed-input::placeholder { color: var(--fg-muted); }
.persona-nav-actions {
    display: flex;
    gap: 6px;
    padding: 8px 12px;
...
.persona-nav-actions .btn { flex: 1; }
.persona-list {
    flex: 1;
    min-height: 0;
    overflow-y: auto;
...
.persona-list-role { color: var(--cyan); }
.persona-empty {
    padding: 24px 10px;
    color: var(--fg-muted);
    font-size: 12px;
...
.persona-toolbar-actions {
    display: flex;
    gap: 6px;
    flex-shrink: 0;
}
.btn-danger { border-color: var(--red); color: var(--red); }
.btn-danger:hover { background: var(--red); color: var(--bg-primary); }
.persona-status {
    margin: 10px 14px 0;
    padding: 6px 8px;
...
.persona-textarea-sm { min-height: 68px; }
.persona-textarea:focus { border-color: var(--blue); }
...
@media (max-width: 760px) {
    ...
    .persona-toolbar-actions .btn { flex: 1; }
    .persona-form-grid { grid-template-columns: minmax(0, 1fr); }
}
...
/* ---- Discovery refactor: hierarchy, two-column layouts, pill selects ---- */
.discovery-title {
    font-size: 18px;
    font-weight: 600;
...
.discovery-field .discovery-textarea {
    margin-bottom: 0;
    min-height: 76px;
    background: var(--bg-primary);
}
...
.selftest-btn:hover:not([disabled]) {
    border-color: var(--blue);
}
.selftest-btn[disabled] {
    cursor: progress;
    opacity: 0.7;
}
.selftest-btn.is-running .selftest-btn-dot {
    background: var(--blue);
}
.selftest-btn-dot {
    width: 8px;
...
.selftest-btn.selftest-status-pass .selftest-btn-dot {
    background: var(--green, #28a745);
}
.selftest-btn.selftest-status-warn .selftest-btn-dot {
    background: var(--yellow, #f0ad4e);
}
.selftest-btn.selftest-status-fail .selftest-btn-dot {
    background: var(--red, #d9534f);
}
.selftest-btn.selftest-status-skipped .selftest-btn-dot {
    background: var(--fg-muted);
}
.selftest-popover {
    position: absolute;
...
.selftest-popover-title {
    font-size: 12px;
    font-weight: 600;
    letter-spacing: 0.04em;
}
.selftest-popover-close {
    background: transparent;
    border: none;
    color: var(--fg-muted);
    font-size: 16px;
...
.selftest-popover-close:hover {
    color: var(--fg-primary);
}
.selftest-popover-body {
    padding: 8px 4px;
    color: var(--fg-muted);
}
.selftest-empty {
...
.selftest-badge.selftest-status-pass {
    background: rgba(40, 167, 69, 0.15);
    border-color: rgba(40, 167, 69, 0.4);
    color: var(--green, #28a745);
}
.selftest-badge.selftest-status-warn {
    background: rgba(240, 173, 78, 0.15);
    border-color: rgba(240, 173, 78, 0.4);
    color: var(--yellow, #d49a3a);
}
.selftest-badge.selftest-status-fail {
    background: rgba(217, 83, 79, 0.15);
    border-color: rgba(217, 83, 79, 0.4);
    color: var(--red, #d9534f);
}
.selftest-badge.selftest-status-skipped {
    background: var(--bg-secondary);
    color: var(--fg-muted);
}
.selftest-summary-text {
    color: var(--fg-muted);
    font-size: 11px;
}
.selftest-popover-meta {
    margin-bottom: 8px;
    font-size: 11px;
    color: var(--fg-muted);
    word-break: break-all;
}
.selftest-popover-meta code {
    background: var(--bg-secondary);
    border-radius: 3px;
    padding: 1px 4px;
}
...
.selftest-check.selftest-status-pass {
    border-left: 3px solid var(--green, #28a745);
}
.selftest-check.selftest-status-warn {
    border-left: 3px solid var(--yellow, #f0ad4e);
}
.selftest-check.selftest-status-fail {
    border-left: 3px solid var(--red, #d9534f);
}
.selftest-check.selftest-status-skipped {
...
.selftest-check.selftest-status-pass .selftest-check-icon { color: var(--green, #28a745); }
.selftest-check.selftest-status-warn .selftest-check-icon { color: var(--yellow, #d49a3a); }
.selftest-check.selftest-status-fail .selftest-check-icon { color: var(--red, #d9534f); }
.selftest-check.selftest-status-skipped .selftest-check-icon { color: var(--fg-muted); }
.selftest-check-body {
    display: flex;
    flex-direction: column;
    gap: 2px;
